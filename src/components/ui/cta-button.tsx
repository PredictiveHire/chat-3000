...
export function CTAButton({ variant = "primary", className, style, children, ...props }: CTAButtonProps) {
  ...
  return (
    <button
      type="button"
      className={cn(
        "w-full rounded-full py-3.5 text-base font-semibold transition-[opacity,scale] duration-150 ease-out active:scale-[0.96] disabled:pointer-events-none disabled:opacity-50",
        variant === "primary"
